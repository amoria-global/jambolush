...
const qaData = [
    ...
    // ---------------- Terms & Conditions ----------------
    { section: "Terms 1 - Definitions", keywords: ["terms 1", "first terms and conditon", "definitions","1 term"], answer: "Explains terms like Platform, Host, Tour Operator, Guest, Field Agent, User, and Content." },
    { section: "Terms 2 - Scope of Services", keywords: ["terms 2", "second terms and Conditions", "scope" ,"2 term"], answer: "Jambolush connects Hosts and Tour Operators with Guests for bookings and experiences." },
    { section: "Terms 3 - Account Registration", keywords: ["terms 3", "third terms and Conditions", "account registration","3 term"], answer: "Users must register with accurate details and safeguard their credentials." },
    { section: "Terms 4 - Host & Tour Operator Obligations", keywords: ["fourth terms and Conditions", "section 4", "host obligations","4 term"], answer: "Hosts and Operators must keep listings accurate, comply with laws, pay fees, and honor bookings." },
    { section: "Terms 5 - Guest Obligations", keywords: ["terms 5", "fifth terms and Conditions", "guest obligations","5 term"], answer: "Guests must provide accurate booking info, respect rules, and avoid damaging property." },
    { section: "Terms 6 - Payments & Fees", keywords: ["terms 6", "sixth terms and Conditions", "payments","6 term"], answer: "Payments must go through approved gateways; direct payments are prohibited." },
    { section: "Terms 7 - Cancellations & Refunds", keywords: ["terms 7", "seveneth terms and Conditions", "cancellations",'7 term'], answer: "Hosts and Operators must set policies; Jambolush may step in for fraud or safety." },
    { section: "Terms 8 - Policies", keywords: ["terms 8", "eightth terms and Conditions", "policies","8 term"], answer: "Includes Privacy, Anti-Discrimination, Field Agent, Content, Security, and Prohibited Activities Policies." },
    { section: "Terms 9 - Intellectual Property", keywords: ["terms 9", "nineth terms and Conditions", "intellectual property","9 term"], answer: "All IP is owned by or licensed to Jambolush; unauthorized use is prohibited." },
    { section: "Terms 10 - Indemnity", keywords: ["terms 10", "tenth terms and Conditions", "indemnity",'10 term'], answer: "Users must cover claims, damages, or costs caused by their actions or breaches." },
    { section: "Terms 11 - Accessibility Commitment", keywords: ["eleventh terms and Conditions", "term 11", "accessibility","11 term"], answer: "Jambolush works to meet accessibility standards for users with disabilities." },
    { section: "Terms 12 - Force Majeure", keywords: ["terms 12", "twelvfth terms and Conditions", "force majeure" ,"12 term"], answer: "Jambolush isn't liable for disruptions caused by events beyond its control." },
    { section: "Terms 13 - Third-Party Services", keywords: ["terms 13", "thirteenth terms and Conditions", "third-party","13 term"], answer: "Jambolush integrates with third-party providers but isn’t liable for their performance." },
    { section: "Terms 14 - Changes to Platform", keywords: ["terms 14", "fourteenth terms and Conditions", "changes","14 term"], answer: "Features may change; major updates will be communicated to users." },
    { section: "Terms 15 - Limitation of Liability", keywords: ["terms 15", "fifteenth terms and Conditions", "liability","15 term"], answer: "Liability is limited to the total fees you paid in the last 12 months." },
    { section: "Terms 16 - Dispute Resolution", keywords: ["terms 16", "sixteenth terms and Conditions", "dispute","16 term"], answer: "Disputes proceed through negotiation, mediation, then arbitration in Kigali." },
    { section: "Terms 17 - Governing Law", keywords: ["terms 17", "seventeenth terms and Conditions", "law","17 term"], answer: "These Terms are governed by the laws of Rwanda." },
    { section: "Terms 18 - Governing Language", keywords: ["terms 18", "eighteenth terms and Conditions", "language","18 term"], answer: "The English version of the Terms prevails over translations." },
    { section: "Terms 19 - Global Compliance", keywords: ["terms 19", "nineteenth terms and Conditions", "compliance","19 term"], answer: "Jambolush complies with GDPR, CCPA, and African privacy regulations." },
    { section: "Terms 20 - Digital Acceptance", keywords: ["terms 20", "twentieth terms and Conditions", "acceptance","20 term"], answer: "By creating an account or using the platform, you accept the Terms." },
    { section: "Terms 21 - Entire Agreement", keywords: ["terms 21", "twenty first terms and Conditions", "entire agreement", "21 term"], answer: "These Terms supersede all previous agreements between you and Jambolush." },
