  ...
  return (
    <div className="min-h-screen bg-white px-4 sm:px-6 lg:px-12 pt-12">
      ...
      <div className="text-center mb-8 sm:mb-12">
        ...
        <p className="text-sm sm:text-sm md:text-lg mt-2 sm:mt-4 mb-6 text-gray-600 max-w-xl mx-auto leading-relaxed">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8 sm:mb-12">
        ...
        <div className="space-y-6 lg:mr-4">
          {/* Contact Info Card */}
          <div className="bg-slate-800 rounded-2xl p-4 sm:p-6 md:p-8 text-white mb-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3 sm:space-x-4">
                <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full flex items-center justify-center bg-pink-600">
                  <i className="bi bi-envelope-fill text-white text-sm sm:text-lg"></i>
                </div>
                <div>
                  <p className="text-sm sm:text-base font-semibold">Email</p>
                  <p className="text-gray-300 text-xs sm:text-sm">info@jambolush.com</p>
                </div>
              </div>

              <div className="flex items-center space-x-3 sm:space-x-4">
                <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full flex items-center justify-center bg-pink-600">
                  <i className="bi bi-telephone-fill text-white text-sm sm:text-lg"></i>
                </div>
                <div>
                  <p className="text-sm sm:text-base font-semibold">Phone</p>
                  <p className="text-gray-300 text-xs sm:text-sm">+250 788 437 347</p>
                </div>
              </div>

              <div className="flex items-center space-x-3 sm:space-x-4">
                <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full flex items-center justify-center bg-pink-600">
                  <i className="bi bi-geo-alt-fill text-white text-sm sm:text-lg"></i>
                </div>
                <div>
                  <p className="text-sm sm:text-base font-semibold">Office</p>
              ...
              <div className="flex items-center space-x-3 sm:space-x-4">
                <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full flex items-center justify-center bg-pink-600">
                  <i className="bi bi-clock-fill text-white text-sm sm:text-lg"></i>
                </div>
                <div>
                  <p className="text-sm sm:text-base font-semibold">Working Hours</p>
                  <p className="text-gray-300 text-xs sm:text-sm">Monday - Friday</p>
                  <p className="text-gray-300 text-xs sm:text-sm">9:00 AM - 6:00 PM EAT</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4 mb-6">
            <div className="bg-slate-800 rounded-2xl p-4 sm:p-6 text-center text-white">
              <h3 className="text-2xl sm:text-3xl font-bold text-pink-500 mb-1">24h</h3>
              <p className="text-gray-300 text-xs sm:text-sm">Response Time</p>
            </div>
            <div className="bg-slate-800 rounded-2xl p-4 sm:p-6 text-center text-white">
              <h3 className="text-2xl sm:text-3xl font-bold text-pink-500 mb-1">100+</h3>
              <p className="text-gray-300 text-xs sm:text-sm">Clients are happy</p>
            </div>
          </div>
        </div>

        {/* Right Column - Form */}
        <div className="bg-slate-800 rounded-2xl p-4 sm:p-6 md:p-8 text-white lg:ml-4 mb-8 sm:mb-12">
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 bg-slate-700 border border-slate-600 rounded-md focus:outline-none focus:border-pink-500 text-sm sm:text-base"
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                rows={5}
                className="w-full px-3 py-2 bg-slate-700 border border-slate-600 rounded-md focus:outline-none focus:border-pink-500 text-sm sm:text-base resize-none"
              />
            ...
            <button
              ...
              className={`w-full bg-pink-500 hover:bg-pink-600 text-white font-semibold py-2 sm:py-3 px-4 rounded-md transition-colors duration-200 flex items-center justify-center space-x-2 text-sm sm:text-base
