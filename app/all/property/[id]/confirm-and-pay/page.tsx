            ...
            <div className="property-card bg-white rounded-lg shadow-sm border border-gray-200 sticky top-4">
              ...
              <div className="p-4 border-b">
                ...
                <ul className="space-y-2 text-sm">
                  ...
                  <li className="flex items-center">
                    <i className="bi bi-door-open mr-2 flex-shrink-0" style={{ color: '#F20C8F' }}></i>
                    <span>4 Bedrooms</span>
                  </li>
                  <li className="flex items-center">
                    <i className="bi bi-droplet mr-2 flex-shrink-0" style={{ color: '#F20C8F' }}></i>
                    <span>3 Bathrooms</span>
                  </li>
                  <li className="flex items-center">
                    <i className="bi bi-wifi mr-2 flex-shrink-0" style={{ color: '#F20C8F' }}></i>
                    <span>High-Speed WiFi</span>
                  </li>
                  <li className="flex items-center">
                    <i className="bi bi-car-front mr-2 flex-shrink-0" style={{ color: '#F20C8F' }}></i>
                    <span>Free Parking</span>
                  </li>
                  <li className="flex items-center">
                    <i className="bi bi-water mr-2 flex-shrink-0" style={{ color: '#F20C8F' }}></i>
